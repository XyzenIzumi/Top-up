...
session_start();
include "koneksi.php";
$sql = mysqli_query($koneksi, "SELECT * FROM tb_admin WHERE id = '1'");
...
if (isset($_POST['id'])) {
  ...
  } elseif(strlen($id) < 8 OR strlen($id) > 12) {
...
// REDIRECT TO WA
  $br = "%0A";
  $nomor = $data->083877118785;

  $pesan = "HALO ADMIN".$br.$br;
  $pesan .= "INFO ORDER TOP UP".$br;
  $pesan .= "ID GAME+:++ ". $id.$br;
  $pesan .= "ITEM +:++ ". $dm.$br;
  $pesan .= "HARGA +:++ ". $dmharga.$br;
...
<div class="container">
  <div class="mt-3 p-2"><img src="img/woi.jpeg" style="width:100%" alt=""></div>


  <h4 class="shadow-sm p-2 mt-3">FREE FIRE</h4>
        ...
        <div class="card-body" style="background-color: rgba(0, 0, 0, 0.9);">
          ...
          <h5 class="p3 mb-2"><span class="d-inline badge badge-pill badge-primary">1</span> LENGKAPI DATA</h5>
              <div class="form-group mt-1">
                <input type="text" class="<?= $validid ?> form-control" name="id" placeholder="Masukkan ID">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body text-dark">
        Masukkan id game sesuai dengan id game free anda
      </div>
